...
/**
 * Class that is responsible for handling registration matters.
 * Responsible for adding dropping swapping and changing indexes of courses
 *
 * @author Anon
 */
...
public class RegistrationManager {
        ...
        if (student instanceof Student) {
            if (timeTableMgr.checkExistingCourse(((Student) student).getIndexOnWaitList(), indexToAdd)) {
                ...
                if (timeTableMgr.checkClash(((Student) student).getIndexOnWaitList(), indexToAdd)) {
                    ...
                    if (((Student) student).getIndexOnWaitList().size() < 5) {
                        ...
                        System.out.println(RED + "You can only have 5 courses on wait list" + RESET);
                    }
                }
            } else {
                if (timeTableMgr.checkClash(((Student) student).getIndexOnWaitList(), indexToAdd)) {
     ...
     */
    public void swapIndex(String userName, String friendUserName, String courseCode, String userIndexNumber, String friendIndexNumber) throws IOException {
