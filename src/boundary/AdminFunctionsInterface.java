            ...
            switch (choice) {
                ...
                case 1:
                    try {
                        ...
                        ((StudentRecordsMgr) objectEntityController).editAccessPeriod(starTime, endTime, startDate, endDate);
                ...
                case 2:
                    ...
                    if (objectEntityController instanceof StudentRecordsMgr)
                        ((StudentRecordsMgr) objectEntityController).addStudent(studentName, networkName, matriculationNumber, emailID, gender, nationality, school, studyYear, password);
                ...
                case 4:
                    ...
                    if (objectEntityController instanceof CourseMgr)
                        ((CourseMgr) objectEntityController).addCourse(courseCode, courseName, academicUnits, school);
                    else System.out.println(RED + "Invalid controller class... Cannot perform this operation" + RESET);
                    break;
                case 5:
                ...
                case 7:
                    ...
                    objectEntityController = new CourseMgr();
                    if (objectEntityController instanceof CourseMgr)
                        ((CourseMgr) objectEntityController).printStudentListByIndex(courseCode, indexNumber);
                    else System.out.println(RED + "Invalid controller class... Cannot perform this operation" + RESET);
                    break;
                case 8:
                    System.out.print("Enter the course code : ");
                    ...
                    objectEntityController = new CourseMgr();
                    if (objectEntityController instanceof CourseMgr)
                        ((CourseMgr) objectEntityController).printStudentListByCourse(courseCode);
                    else System.out.println(RED + "Invalid controller class... Cannot perform this operation" + RESET);
                    break;
                case 9:
                    objectEntityController = new StudentRecordsMgr();
                ...
                case 12:
                    ...
                    objectEntityController = new CourseMgr();
                    if (objectEntityController instanceof CourseMgr)
                        ((CourseMgr) objectEntityController).printLessons(courseCode, indexNumber);
                    else System.out.println(RED + "Invalid controller class... Cannot perform this operation" + RESET);
                    break;
                default:
